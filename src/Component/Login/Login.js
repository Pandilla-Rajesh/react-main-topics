...
const Login = () => {
    ...
    //     console.log(login, 'login details fetched')
    // }, [login])
                ...
                <div className='py-4'>
                    <div className=' grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 
                     max-w-full shadow-lg hover:shadow-lg translate-xl rounded-lg overflow-hidden'>
                                ...
                                <form className='w-full flex gap-3 flex-col' onSubmit={ handleSubmit }>
                                    <div className='w-full'>
                                        ...
                                        ${error.userName ? 'border-red-500 ring ring-red-500' : 'border-gray-500'}` }
                                            ...
                                            <p>{ error.userName &&
                                                <small className='text-sm text-red-600'>{ error.userName }</small> }</p>
                                        </label>
                                    </div>
                                    ...
                                    <div className='w-full'>
                                        ...
                                        focus:outline-none focus:border-sky-800 focus:ring-sky-800 rounded-md w-full'
                                                    ...
                                                    <span onClick={ toggleVisible } className=' absolute right-3 top-1/2
                                                 text-slate-600 cursor-pointer 
                                                -translate-y-1/2'>
                                                        { showpassword ?
                                                            <i className="bi bi-eye"></i> : <i className="bi bi-eye-slash"></i> }
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div className='bg-green-400 bg-gradient-to-tr from-green-600
                         to-green-900 hidden md:visible lg:visible hidden md:block lg:block'>
